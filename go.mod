...
replace go.podman.io/common => github.com/mtrmac/container-libs/common v0.0.0-20251103204442-de2a06c21bd7

replace go.podman.io/storage => github.com/mtrmac/container-libs/storage v0.0.0-20251103204442-de2a06c21bd7

replace go.podman.io/image/v5 => github.com/mtrmac/container-libs/image/v5 v5.0.0-20251103204442-de2a06c21bd7
