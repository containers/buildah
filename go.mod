...
replace go.podman.io/common => github.com/bitoku/container-libs/common v0.0.0-20251210174943-c5262c0fa1d3

replace go.podman.io/storage => github.com/bitoku/container-libs/storage v0.0.0-20251210174943-c5262c0fa1d3

replace go.podman.io/image/v5 => github.com/bitoku/container-libs/image/v5 v5.0.0-20251210174943-c5262c0fa1d3
