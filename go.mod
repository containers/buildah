...
replace go.podman.io/common => github.com/jlebon/container-libs/common v0.0.0-20251120020159-9ccdd0470c8d

replace go.podman.io/storage => github.com/jlebon/container-libs/storage v0.0.0-20251120020159-9ccdd0470c8d

replace go.podman.io/image/v5 => github.com/jlebon/container-libs/image/v5 v5.0.0-20251120020159-9ccdd0470c8d
