...
replace go.podman.io/common => github.com/ashley-cui/container-libs/common v0.0.0-20260105143646-af797bd6f0f2

replace go.podman.io/storage => github.com/ashley-cui/container-libs/storage v0.0.0-20260105143646-af797bd6f0f2

replace go.podman.io/image/v5 => github.com/ashley-cui/container-libs/image/v5 v5.0.0-20260105143646-af797bd6f0f2
