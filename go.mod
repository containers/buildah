...
replace (
	...
	github.com/containers/common => github.com/containers/common v0.57.7
	github.com/containers/image/v5 => github.com/containers/image/v5 v5.29.4
	github.com/containers/ocicrypt => github.com/containers/ocicrypt v1.1.10
	github.com/containers/storage => github.com/containers/storage v1.51.2
	github.com/docker/docker => github.com/docker/docker v20.10.0+incompatible
	github.com/docker/libnetwork => github.com/docker/libnetwork v0.8.0-dev.2.0.20190625141545-5a177b73e316
	github.com/fsouza/go-dockerclient => github.com/fsouza/go-dockerclient v1.10.0
	github.com/openshift/imagebuilder => github.com/openshift/imagebuilder v1.2.2-0.20210415181909-87f3e48c2656
