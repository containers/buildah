...
replace go.podman.io/common => github.com/lsm5/container-libs/common v0.0.0-20251126194043-bdbac3449d9d

replace go.podman.io/storage => github.com/lsm5/container-libs/storage v0.0.0-20251126194043-bdbac3449d9d

replace go.podman.io/image/v5 => github.com/lsm5/container-libs/image/v5 v5.0.0-20251126194043-bdbac3449d9d
