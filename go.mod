...
replace go.podman.io/common => github.com/lsm5/container-libs/common v0.0.0-20251128160112-5ef64fc4bfac

replace go.podman.io/storage => github.com/lsm5/container-libs/storage v0.0.0-20251128160112-5ef64fc4bfac

replace go.podman.io/image/v5 => github.com/lsm5/container-libs/image/v5 v5.0.0-20251128160112-5ef64fc4bfac
