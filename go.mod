...
replace go.podman.io/common => github.com/rhatdan/container-libs/common v0.0.0-20251121155159-db5cf0aa7ffd

replace go.podman.io/storage => github.com/rhatdan/container-libs/storage v0.0.0-20251121155159-db5cf0aa7ffd

replace go.podman.io/image/v5 => github.com/rhatdan/container-libs/image/v5 v5.0.0-20251121155159-db5cf0aa7ffd
