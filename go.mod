...
require (
	...
	github.com/containers/storage v1.42.1-0.20220916072138-4e0f0fb8f5b0
...
replace github.com/containers/common => github.com/giuseppe/common v0.0.8-0.20220916144609-52108b71e1a2
