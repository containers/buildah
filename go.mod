...
replace go.podman.io/common => github.com/mtrmac/container-libs/common v0.0.0-20251205234617-cf97f48d3ceb

replace go.podman.io/storage => github.com/mtrmac/container-libs/storage v0.0.0-20251205234617-cf97f48d3ceb

replace go.podman.io/image/v5 => github.com/mtrmac/container-libs/image/v5 v5.0.0-20251205234617-cf97f48d3ceb
