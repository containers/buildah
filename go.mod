...
replace go.podman.io/common => github.com/clan/container-libs/common v0.0.0-20251218040737-ef385448353b

replace go.podman.io/storage => github.com/clan/container-libs/storage v0.0.0-20251218040737-ef385448353b

replace go.podman.io/image/v5 => github.com/clan/container-libs/image/v5 v5.0.0-20251218040737-ef385448353b
