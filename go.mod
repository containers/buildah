...
replace go.podman.io/common => github.com/TomSweeneyRedHat/container-libs/common v0.0.0-20251031192508-caf2985dd83b

replace go.podman.io/storage => github.com/TomSweeneyRedHat/container-libs/storage v0.0.0-20251031192508-caf2985dd83b

replace go.podman.io/image/v5 => github.com/TomSweeneyRedHat/container-libs/image/v5 v5.0.0-20251031192508-caf2985dd83b
