...
replace go.podman.io/common => github.com/rodneyosodo/container-libs/common v0.0.0-20260118194833-ef6d0f324400

replace go.podman.io/storage => github.com/rodneyosodo/container-libs/storage v0.0.0-20260118194833-ef6d0f324400

replace go.podman.io/image/v5 => github.com/rodneyosodo/container-libs/image/v5 v5.0.0-20260118194833-ef6d0f324400
