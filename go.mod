...
replace go.podman.io/common => github.com/jlebon/container-libs/common v0.0.0-20251114185635-47ee7e410eaa

replace go.podman.io/storage => github.com/jlebon/container-libs/storage v0.0.0-20251114185635-47ee7e410eaa

replace go.podman.io/image/v5 => github.com/jlebon/container-libs/image/v5 v5.0.0-20251114185635-47ee7e410eaa
