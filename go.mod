...
replace go.podman.io/common => github.com/TomSweeneyRedHat/container-libs/common v0.0.0-20251017155815-8163ca799c31

replace go.podman.io/storage => github.com/TomSweeneyRedHat/container-libs/storage v0.0.0-20251017155815-8163ca799c31

replace go.podman.io/image/v5 => github.com/TomSweeneyRedHat/container-libs/image/v5 v5.0.0-20251017155815-8163ca799c31
