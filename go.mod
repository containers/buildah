...
replace go.podman.io/common => github.com/containers/container-libs/common v0.66.1-0.20251021130723-6d1aad0ed240

replace go.podman.io/storage => github.com/containers/container-libs/storage v1.61.1-0.20251021130723-6d1aad0ed240

replace go.podman.io/image/v5 => github.com/containers/container-libs/image/v5 v5.38.1-0.20251021130723-6d1aad0ed240
