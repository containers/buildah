...
replace go.podman.io/common => github.com/mtrmac/container-libs/common v0.0.0-20251211220343-25d5ffc88cd5

replace go.podman.io/storage => github.com/mtrmac/container-libs/storage v0.0.0-20251211220343-25d5ffc88cd5

replace go.podman.io/image/v5 => github.com/mtrmac/container-libs/image/v5 v5.0.0-20251211220343-25d5ffc88cd5
