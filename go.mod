...
replace go.podman.io/common => github.com/pablintino/container-libs/common v0.0.0-20260116170014-846c0349013e

replace go.podman.io/storage => github.com/pablintino/container-libs/storage v0.0.0-20260116170014-846c0349013e

replace go.podman.io/image/v5 => github.com/pablintino/container-libs/image/v5 v5.0.0-20260116170014-846c0349013e
