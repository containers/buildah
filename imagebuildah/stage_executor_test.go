...
func TestSanitizeImageName(t *testing.T) {
	...
	newGoodLayout, err := sanitizeImageName("oci", goodLayoutRel, contextDir, t.TempDir())
	...
	newGoodDir, err := sanitizeImageName("dir", goodDirRel, contextDir, t.TempDir())
	...
	newGoodOCIArchive, err := sanitizeImageName("oci-archive", goodOCIArchiveRel, contextDir, t.TempDir())
	...
	newGoodDockerArchive, err := sanitizeImageName("docker-archive", goodDockerArchiveRel, contextDir, t.TempDir())
	...
	_, err = sanitizeImageName("oci", badLayoutRel, contextDir, t.TempDir())
	...
	_, err = sanitizeImageName("dir", badDirRel, contextDir, t.TempDir())
	...
	_, err = sanitizeImageName("oci-archive", badOCIArchiveRel, contextDir, t.TempDir())
	...
	_, err = sanitizeImageName("docker-archive", badDockerArchiveRel, contextDir, t.TempDir())
