...
## v1.29.6 (2025-12-09)
    ...
    [release-1.29] finish switching to moby/sys/capability
    [release-1.29] tests/tools: bump golangci-lint and golang.org/x/tools
    [release-1.29] Silence new linter warnings
