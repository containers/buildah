...
@test "add-plain" {
	...
	mkdir $root/subdir $root/other-subdir $root/cwd
	...
	# Copy a file to a specific location, created as a file
	buildah add --name=$cid --dest=/other-randomfile ${TMPDIR}/other-randomfile
	...
	cmp ${TMPDIR}/other-randomfile $newroot/other-randomfile
