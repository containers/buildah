...
@test "add-link-flag" {
  ...
  run_buildah unmount $cid
  run_buildah commit $WITH_POLICY_JSON $cid containers-storage:add-link-image
...
@test "add-link-archive" {
  ...
  run_buildah commit $WITH_POLICY_JSON $cid containers-storage:add-link-archive-image
...
@test "add-link-directory" {
  ...
  run_buildah commit $WITH_POLICY_JSON $cid containers-storage:add-link-dir-image
