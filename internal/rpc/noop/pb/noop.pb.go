...
const file_noop_proto_rawDesc = "" +
	...
	"\x04Noop\x12?\n" +
	"\x04Noop\x12\x1a.io.buildah.v1.NoopRequest\x1a\x1b.io.buildah.v1.NoopResponseB4Z2github.com/containers/buildah/internal/rpc/noop/pbb\x06proto3"
...
var file_noop_proto_goTypes = []any{
	(*NoopRequest)(nil),  // 0: io.buildah.v1.NoopRequest
	(*NoopResponse)(nil), // 1: io.buildah.v1.NoopResponse
}
var file_noop_proto_depIdxs = []int32{
	0, // 0: io.buildah.v1.Noop.Noop:input_type -> io.buildah.v1.NoopRequest
	1, // 1: io.buildah.v1.Noop.Noop:output_type -> io.buildah.v1.NoopResponse
